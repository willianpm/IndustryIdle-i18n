export const PT_BR = {
    ...
    RatingHold: "Segurar",
    RatingOutperform: "Exceder", // produtivo
    RatingUnderperform: "Underperform", // improdutivo
    ...
    Tips7: "Quando você compra um recurso, o seu preço aumenta. Quando você vende um recurso, o seu preço baixa.",
    ...
    FPS30Desc:
        "Ativar o modo de economia de energia executará o jogo a 30FPS em vez de 60FPS. Isso fará com que sua bateria dure mais tempo",
    ...
    FuelRunOutWarning: "💡 Seu consumo de combustível excede a produção. Quando o combustível acabar, seu transporte irá parar",
    InAmount: "In: %{number}",
    ...
    RequireAnyExpansionPack: "Pacote de expansão exclusivo",
    ...
    PurchaseSteamContinue: "Conclua sua compra na Steam",
    ...
    SaveFileMigrated: "Uma nova era: o beta chegou",
    SaveFileMigratedDesc:
        "Obrigado por jogar o teste em alfa. Seu mapa antigo não é compatível, mas migramos seus dados e oferecemos alguns bônus",
    ClaimSwissMoney: "Receber %{amount} Dinheiro Suiço 💵",
    SaveFileMigratedFinePrint:
        "Sua capitalização de mercado é convertida em dinheiro suíço e o dinheiro suíço não gasto é transportado. Você receberá um bônus de 50% em dinheiro suíço para jogar o teste em alfa. O máximo de dinheiro suíço que pode ser transportado é limitado a 200",
    CashIn: "Resgatar",
    ...
    Rotterdam: "Rotterdam",
    RotterdamBonus:
        "<li>As siderúrgicas têm capacidade 2x</li><li>Plantas de aço inoxidável têm capacidade 2x</li><li>Transporte gratuito de ferro</li><li>Transporte de aço custa 50% menos combustível</li><li>Comece com 2x a capacidade de venda automática</li><li>Sem modificadores de bloco</li>",
    Oslo: "Oslo",
    StPetersburg: "St. Petersburg",
    StPetersburgBonus:
        "<li>As minas de urânio têm produção 2x</li><li>Plantas de enriquecimento de urânio têm capacidade 2x</li><li>O transporte de urânio custa 50% menos combustível</li><li>Transporte gratuito de armas</li><li>Fábricas de mísseis usam urânio enriquecido em vez de titânio e urânio</li>",
    Hamburg: "Hamburg",
    HamburgBonus:
        "<li>As fábricas da Zeppelin estão desbloqueadas</li><li>As fábricas de semicondutores têm 2x a produtividade</li><li>Os estaleiros têm capacidade 2x</li><li>As fábricas de automóveis têm capacidade 2x</li><li>As fábricas de baterias de íon-lítio estão desbloqueadas</li>",
    Toulouse: "Toulouse",
    ToulouseBonus:
        "<li>As minas de titânio têm produção 2x</li><li>Plantas de enriquecimento de urânio têm produtividade 2x</li><li>As fábricas de motores a jato têm capacidade 2x</li><li>As fábricas de aeronaves têm 2x a produtividade</li><li>Fábricas de foguetes usam urânio em vez de urânio enriquecido</li>",
    Rome: "Rome",
    RomeBonus:
